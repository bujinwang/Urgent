...
html_content = open('news.html', 'r').read() + open('case-detail.html', 'r').read()
...
print("Missing CSS in subpages:", sorted(missing_css))
print("Missing JS in subpages:", sorted(missing_js))
