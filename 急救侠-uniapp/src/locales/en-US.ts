...
export default {
  ...
  aed: {
    ...
    status: { available: 'Available', inUse: 'In use', maintenance: 'Maintenance' },
  ...
  hours: {
    ...
    total: 'Total volunteer service',
    minutes: '{n} min',
    breakdownTitle: 'Breakdown',
    detailTitle: 'Service details',
    empty: 'No service records yet',
    loadFailed: 'Failed to load service hours',
    ...
    activity: {
      ...
      drill: 'Drill',
      training: 'Training',
      aed_checkin: 'AED check-in',
      manual: 'Manual entry',
    },
  },
  serviceCert: {
    title: 'My Service Certificates',
    docTitle: 'Volunteer Service Record Certificate (issued by Jiujiaxia platform)',
    disclaimer: 'Issued by the platform; not identity-verified',
    empty: 'No certificates yet',
    generate: 'Generate certificate',
    generating: 'Generating…',
    createFailed: 'Failed to generate certificate',
    period: '{from} to {to}',
    totalMinutes: '{n} min in total',
    print: 'Print / Save as PDF',
    revoke: 'Revoke',
    revokeConfirm: 'Revoke this certificate? It will no longer be valid.',
    revoked: 'This certificate has been revoked',
    revokeFailed: 'Failed to revoke the certificate',
    verifyTitle: 'Verify a certificate number',
    verifyPlaceholder: 'Enter the certificate number',
    verify: 'Verify',
