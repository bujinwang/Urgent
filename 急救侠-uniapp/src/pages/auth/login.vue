<template>
  <view>
    ...
    <view style="margin:0 40rpx;background:#fff;border-radius:24rpx;padding:30rpx">
      ...
      <input v-if="curTab==='register'" style="width:100%;height:44px;border:1px solid #ddd;border-radius:8px;padding:0 12px;font-size:16px;margin-bottom:12px;box-sizing:border-box" :value="name" @input="name=uniInputValue($event)" placeholder="姓名（选填）" />
      ...
      <input style="width:100%;height:44px;border:1px solid #ddd;border-radius:8px;padding:0 12px;font-size:16px;margin-bottom:12px;box-sizing:border-box" :value="pwd" @input="pwd=uniInputValue($event)" placeholder="密码" type="password" />
