<template>
  <view class="page-learn">
    ...
    <view class="learn-tabs">
      <view class="learn-tab" :class="{ active: learnStore.currentTab === 'knowledge' }" @click="learnStore.setTab('knowledge')">急救知识</view>
      <view class="learn-tab" :class="{ active: learnStore.currentTab === 'training' }" @click="learnStore.setTab('training')">实操训练</view>
    </view>
    ...
    <view v-if="learnStore.currentTab === 'knowledge'">
      ...
      <view class="lesson-list">
        <view v-for="item in learnStore.lessons" :key="item.id" class="lesson-item">
    ...
    <!-- 训练模块 -->
    <view v-if="learnStore.currentTab === 'training'">
      <!-- 演习模式提示 -->
      ...
      <view class="train-grid">
        <view v-for="item in learnStore.trainings" :key="item.id" class="train-card" @click="startTraining(item.id)">
...
function startTraining(id: string) {
  const route = learnStore.startTraining(id)
  if (route) {
    if (id === 'aed') uni.switchTab({ url: route })
